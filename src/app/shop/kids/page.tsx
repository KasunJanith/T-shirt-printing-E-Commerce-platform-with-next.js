...
export default function KidsShopPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-orange-400 via-yellow-400 to-orange-500 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Kids' Collection</h1>
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-8">          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-semibold mb-1 text-gray-900">Kid-Friendly</h3>
              <p className="text-sm text-gray-700">Safe and soft materials</p>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-2">🌈</div>
              <h3 className="font-semibold mb-1 text-gray-900">Vibrant Colors</h3>
              <p className="text-sm text-gray-700">Fun designs they'll love</p>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-2">🛡️</div>
              <h3 className="font-semibold mb-1 text-gray-900">Durable</h3>
              <p className="text-sm text-gray-700">Built for active kids</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">        {loading ? (
          ...
          <>
            <div className="mb-8">
              <h2 className="text-3xl font-bold mb-2 text-gray-900">Kids' T-Shirts</h2>
