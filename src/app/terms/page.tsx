...
export default function TermsPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-slate-700 to-slate-900 dark:from-slate-800 dark:to-slate-950 text-white py-16">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="p-8 mb-8 dark:border-gray-700 dark:bg-gray-800">
            <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">2. Use of Services</h2>
            
            <div className="space-y-6">
              <div>
                <h3 className="font-semibold text-lg mb-3 text-gray-900 dark:text-white">Eligibility</h3>
                ...
                <h3 className="font-semibold text-lg mb-3 text-gray-900 dark:text-white">Account Registration</h3>
                <ul className="space-y-2 text-gray-700 dark:text-gray-300 ml-6">
                ...
                <h3 className="font-semibold text-lg mb-3 text-gray-900 dark:text-white">Prohibited Activities</h3>
          ...
          <Card className="p-8 mb-8 dark:border-gray-700 dark:bg-gray-800">
            <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">3. Products and Orders</h2>
            
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold mb-2 text-gray-900 dark:text-white">Product Descriptions</h3>
                <p className="text-gray-700 dark:text-gray-300">
                ...
                <h3 className="font-semibold mb-2 text-gray-900 dark:text-white">Pricing</h3>
                <ul className="space-y-2 text-gray-700 dark:text-gray-300 ml-6">
                ...
                <h3 className="font-semibold mb-2 text-gray-900 dark:text-white">Order Acceptance</h3>
                <p className="text-gray-700 dark:text-gray-300">
                ...
                <h3 className="font-semibold mb-2 text-gray-900 dark:text-white">Payment</h3>
                <ul className="space-y-2 text-gray-700 dark:text-gray-300 ml-6">
          ...
          <Card className="p-8 mb-8 dark:border-gray-700 dark:bg-gray-800">
            <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">4. Shipping and Delivery</h2>
          ...
          <Card className="p-8 mb-8 dark:border-gray-700 dark:bg-gray-800">
            <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">5. Returns and Refunds</h2>
          ...
          <Card className="p-8 mb-8 dark:border-gray-700 dark:bg-gray-800">
            <h2 className="text-2xl font-bold mb-6 flex items-center text-gray-900 dark:text-white">
              <Scale className="h-6 w-6 mr-3 text-blue-600 dark:text-blue-400" />
          ...
          <Card className="p-8 mb-8 bg-yellow-50 dark:bg-yellow-900/20 border-yellow-200 dark:border-yellow-800">
            <h2 className="text-2xl font-bold mb-6 flex items-center text-gray-900 dark:text-white">
              <AlertCircle className="h-6 w-6 mr-3 text-yellow-600 dark:text-yellow-400" />
          ...
          <Card className="p-8 mb-8 dark:border-gray-700 dark:bg-gray-800">
            <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">8. Indemnification</h2>
            ...
            <ul className="space-y-2 text-gray-700 dark:text-gray-300 ml-6 mt-4">
          ...
          {/* Governing Law */}
          <Card className="p-8 mb-8 dark:border-gray-700 dark:bg-gray-800">
            <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">9. Governing Law</h2>
          ...
          {/* Changes to Terms */}
          <Card className="p-8 mb-8 dark:border-gray-700 dark:bg-gray-800">
            <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">10. Changes to Terms</h2>
          ...
          {/* Severability */}
          <Card className="p-8 mb-8 dark:border-gray-700 dark:bg-gray-800">
            <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">11. Severability</h2>
